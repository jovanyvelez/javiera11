/* ============================================================
   CLASE ocho — HERRAMIENTAS DE PROGRAMACIÓN II
...
const STORAGE_KEY = 'curso-herr-8';
...
function marcarCompletado(n) {
  ...
  const badgesModulo = {0: "🚀 Iniciado", 1: "🔁 Repaso", 2: "🌊 Flujo", 3: "♻️ CRUD", 4: "☕ Descansado", 5: "🛡️ Validación", 6: "🖥️ Frontend", 7: "🏆 Integrador Master"};
  if (badgesModulo[n]) otorgarBadge(badgesModulo[n]);

  if (estado.completados.size === TOTAL_MODULOS) {
    otorgarBadge('🏆 Integrador Dominado');
  }
...
function actualizarUI() {
  ...
  if (mAct) {
    const labels = ['Inicio', 'Repaso', 'Flujo', 'CRUD', 'Descanso', 'Validación', 'Frontend', 'Proyecto'];
