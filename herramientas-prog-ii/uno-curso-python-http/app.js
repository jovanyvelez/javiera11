/* ============================================================
   CLASE uno — HERRAMIENTAS DE PROGRAMACIÓN II
...
const STORAGE_KEY = 'curso-herr-1';
...
function marcarCompletado(n) {
  ...
  const badgesModulo = {0: "🚀 Iniciado", 1: "🐍 Python Base", 2: "⚡ async/await", 3: "🌐 HTTP", 4: "☕ Descansado", 5: "📨 Request/Response", 6: "📦 JSON", 7: "🛠️ Python+HTTP Master"};
  if (badgesModulo[n]) otorgarBadge(badgesModulo[n]);

  if (estado.completados.size === TOTAL_MODULOS) {
    otorgarBadge('🏆 Python + HTTP Dominado');
  }
...
function actualizarUI() {
  ...
  if (mAct) {
    const labels = ['Inicio', 'Python', 'async/await', 'HTTP', 'Descanso', 'Request/Response', 'JSON', 'Taller'];
